...
export default function RestaurantCard({restInfo}){
    ...
    return (
			<Link to={"/city/thane/"+ restInfo?.info?.id}>
				<div className="max-w-[270px] duration-200 transform transition hover:scale-95">
					<div className="relative">
						...
						<div className="flex items-center my-auto mt-2 font-sans">
							<div className="flex items-center justify-center w-5 h-5 rounded-full bg-[#07a145] ml-3">
								<svg
									className="w-3 h-4 fill-white"
									viewBox="0 0 24 24"
								>
